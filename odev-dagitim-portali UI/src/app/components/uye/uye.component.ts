...
export class UyeComponent implements OnInit {
  uyeler!: Uye[];
  displayedColumns = ["uyeId", "kullaniciAdi", "adSoyad", "sifre", "email", "uyeYetki", "islemler"]
  dataSource: any;
  ...
  UyeSil(kayit: Uye){
    ...
    this.confirmDialogRef.componentInstance.dialogMesaj = '"' + kayit.kullaniciAdi + '" ' + " Üye Silinecektir Onaylıyor musunuz?";
